    ...
    for (int i=0; i<_yValues.count; i++) {
        ...
        [self addPoint:CGPointMake(xPosition, chartCavanHeight - grade * chartCavanHeight+UULabelHeight)
                ...
                isShow:isShowMaxAndMinPoint
                 value:firstValue andCurrentIndex:0];
        ...
        for (NSString * valueString in childAry) {
            ...
            if (index != 0) {
                ...
                [self addPoint:point
                         index:i
                        isShow:isShowMaxAndMinPoint
                         value:[valueString floatValue] andCurrentIndex:index];
...
- (void)addPoint:(CGPoint)point index:(NSInteger)indexValue isShow:(BOOL)isHollow value:(CGFloat)value andCurrentIndex:(NSInteger)currentIndex
{
    //Chart Circle View
    UIView *viewUpdated = [[UIView alloc]initWithFrame:CGRectMake(5, 5, 16, 16)];
    viewUpdated.center = point;
    viewUpdated.layer.masksToBounds = YES;
    viewUpdated.layer.cornerRadius = 8;
    viewUpdated.layer.borderWidth = 2;
    viewUpdated.backgroundColor = [UIColor clearColor];
    viewUpdated.layer.borderColor = [[_colors objectAtIndex:indexValue] CGColor]?[[_colors objectAtIndex:indexValue] CGColor]:UUGreen.CGColor;
    
    if (indexValue == 0) {
        [viewUpdated setTag:currentIndex+100];
    }
    else
        [viewUpdated setTag:currentIndex+1000];
    

      if (isHollow) {
        viewUpdated.backgroundColor = [UIColor whiteColor];
        //[self addPopTipOnCalendarButtonToView:view andLabel:view andValue:value];
       }
    else{
        viewUpdated.backgroundColor = [_colors objectAtIndex:indexValue]?[_colors objectAtIndex:indexValue]:UUGreen;
        /*
        //Chart Min and Max Lable
