...
-(void)viewDidLayoutSubviews {
    ...
    [self.contentViewContainer layoutSubviews];
    [self.contentViewContainer updateConstraints];
}
...
{
    //NSLog(@"initWithContentViewController");
...
{
   // NSLog(@"presentLeftMenuViewController");
...
//    NSLog(@"viewDidLoad");
   ...
   // self.leftMenuViewController.view.backgroundColor = [UIColor redColor];
...
{
    //NSLog(@"presentMenuViewContainerWithMenuViewController");

    [self setAnchorPoint:CGPointMake(0.0, 0.5) forView:_menuViewContainer];
    self.menuViewContainer.transform = CGAffineTransformIdentity;
    self.menuViewContainer.frame = self.view.bounds;
       //NSLog(@"NSStringFromCGRect %@",NSStringFromCGRect(self.menuViewContainer.frame));
    if (_menuViewRotatingAngle != 0) {
      ...
      CATransform3D  menuRotationTransform  = CATransform3DMakeRotation(_menuViewRotatingAngle * M_PI/180.0f, 0.0f, -1.0f, 0.0f);
...
{
    //NSLog(@"showLeftMenuViewController");
    if (!self.leftMenuViewController) {
        return;
    }
    ...
    //_contentViewContainer.frame = CGRectMake(_contentViewContainer.frame.origin.x, _contentViewContainer.frame.origin.y, _contentViewContainer.frame.size.width-100, _contentViewContainer.frame.size.height-200);
    [self setAnchorPoint:CGPointMake(0.0, 0.5) forView:_menuViewContainer];
    [self setAnchorPoint:CGPointMake(0.0, 0.4) forView:_contentViewContainer];
    [self setAnchorPoint:CGPointMake(0.0, 0.5) forView:_contentViewController.view];
    
    [UIView animateWithDuration:self.animationDuration animations:^{
        
        //content view scale transform
      //  CATransform3D contentScaleTransform =  _contentViewContainer.layer.transform;
        CATransform3D contentScaleTransform = CATransform3DMakeScale(_contentViewScaleValue, _contentViewScaleValue,1.0f);
        ...
        if (_contentViewRotatingAngle != 0) {
          ...
          //  CATransform3D contentRotateTransform =  _contentViewController.view.layer.transform;
           CATransform3D contentRotateTransform = CATransform3DMakeRotation(_contentViewRotatingAngle * M_PI/180.0f, 0.0f, -1.0f, 0.0f);
        ...
        contentTranslateTransform = CATransform3DTranslate(contentTranslateTransform, 125, 0, 0);
        ...
        if (_menuViewRotatingAngle != 0) {
          ...
          CATransform3D  menuRotateTransform = CATransform3DMakeRotation(0 * M_PI/180.0f, 0.0f, -1.0f, 0.0f);
...
- (void)hideMenuViewControllerAnimated:(BOOL)animated
{
    ...
    //_contentViewContainer.frame = CGRectMake(0,0, self.contentViewContainer.frame.size.width+50 ,_contentViewContainer.frame.size.height+122);

    //NSLog(@"hideMenuViewControllerAnimated");
    ...
    void (^animationBlock)(void) = ^{
        ...
        if (!strongSelf) {
            ...
            [self setAnchorPoint:CGPointMake(0.0, 0.5) forView:_contentViewContainer];
        
            //content view scale transform
          //  CATransform3D contentScaleTransform =  _contentViewContainer.layer.transform;
         CATransform3D   contentScaleTransform = CATransform3DMakeScale(1.0, 1.0,1.0f);
            _contentViewContainer.layer.transform = contentScaleTransform;

            if (_contentViewRotatingAngle != 0) {
                //content view rotate transform
            //    CATransform3D contentRotateTransform =  _contentViewController.view.layer.transform;
              CATransform3D contentRotateTransform = CATransform3DMakeRotation(0 * M_PI/180.0f, 0.0f, 0.0f, 0.0f);
                CATransform3D sublayerTransform = _contentViewController.view.superview.layer.sublayerTransform;
                sublayerTransform.m34 = 1.0f / -300.0f;
                _contentViewController.view.superview.layer.sublayerTransform = sublayerTransform;
                _contentViewController.view.layer.transform = contentRotateTransform;
            ...
            if (_menuViewRotatingAngle != 0) {
                //menu view rotate transform
            //    CATransform3D menuRotateTransform =  _leftMenuViewController.view.layer.transform;
              CATransform3D  menuRotateTransform = CATransform3DMakeRotation(_menuViewRotatingAngle * M_PI/180.0f, 0.0f, -1.0f, 0.0f);
                CATransform3D sublayerTransform1 = _leftMenuViewController.view.superview.layer.sublayerTransform;
                sublayerTransform1.m34 = 1.0f / -300.0f;
                _leftMenuViewController.view.superview.layer.sublayerTransform = sublayerTransform1;
                _leftMenuViewController.view.layer.transform = menuRotateTransform;
    ...
    //_contentViewContainer.frame = CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT);
}

//content button added as subview when left menu is shown
- (void)addContentButton
{
    //NSLog(@"addContentButton");
    ...
    if (recognizer.state == UIGestureRecognizerStateChanged) {
        ...
        if((newLocationPoint.x >= 0 && newLocationPoint.x <= 300))
        {
            ...
            [UIView animateWithDuration:self.animationDuration animations:^{
                ...
                //content view scale transform
               // CATransform3D contentScaleTransform =  _contentViewContainer.layer.transform;
              CATransform3D  contentScaleTransform = CATransform3DMakeScale(contentViewScale, contentViewScale,1.0f);
                _contentViewContainer.layer.transform = contentScaleTransform;

                if (angle != 0) {
                    //content view rotate transform
                    //CATransform3D contentRotateTransform =  _contentViewController.view.layer.transform;
                  CATransform3D  contentRotateTransform = CATransform3DMakeRotation(_totalAngle * M_PI/180.0f, 0.0f, -1.0f, 0.0f);
                    CATransform3D sublayerTransform = _contentViewController.view.superview.layer.sublayerTransform;
                    sublayerTransform.m34 = 1.0f / -300.0f;
                    _contentViewController.view.superview.layer.sublayerTransform = sublayerTransform;
                    _contentViewController.view.layer.transform = contentRotateTransform;
                ...
                if (angle != 0) {
                    ...
                    //menu view rotate transform
                   // CATransform3D menuRotateTransform =  _leftMenuViewController.view.layer.transform;
                  CATransform3D  menuRotateTransform = CATransform3DMakeRotation(menuAngle * M_PI/180.0f, 0.0f, -1.0f, 0.0f);
                    CATransform3D sublayerTransform1 = _leftMenuViewController.view.superview.layer.sublayerTransform;
                    sublayerTransform1.m34 = 1.0f / -300.0f;
                    _leftMenuViewController.view.superview.layer.sublayerTransform = sublayerTransform1;
                    _leftMenuViewController.view.layer.transform = menuRotateTransform;
...
{
    //NSLog(@"setLeftMenuViewController");
...
- (void)setAnchorPoint:(CGPoint)anchorPoint forView:(UIView *)view {
   ...
   // NSLog(@"setAnchorPoint%@",NSStringFromCGPoint(view.center ));
}
...
- (void) adjustViewsForOrientation:(UIInterfaceOrientation) orientation {
    ...
    if (self.visible)
        _contentViewContainer.frame = CGRectMake(_contentViewContainer.frame.origin.x, WINHEIGHT/10, WINWIDTH, WINHEIGHT);
}
